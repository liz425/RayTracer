...
public:
  ...
  //type 1 / 2, directional or point light
...
//  sce.v_view = Vector3D(0, 1, 0);
  sce.p_eye = Point3D(-20, -50, 0);
  sce.v_view = Vector3D(0.4, 1, 0);
  ...
  light_src* light_src2 = new light_src(2, Point3D(0, -50, 50), Vector3D(0.2, 1.4, -1), Vector3D( 1, 1, 1), 30);
